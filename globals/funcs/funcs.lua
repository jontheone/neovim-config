...
vim.keymap.set('n', '<Leader>mg', ':Meta verbose=1<CR>', { desc="verbose greedy metadata search"})
vim.keymap.set('n', '<Leader>mn', ':Meta verbose=1 search=nongreedy<CR>', { desc="verbose nongreedy metadata search"})
vim.keymap.set('n', '<Leader>ms', ':Meta<CR>', { desc="Metadata search"})
vim.keymap.set('n', '<Leader>ml', ':Meta links=1<CR>', { desc="Search with link keyword"})
